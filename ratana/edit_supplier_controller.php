...
if(!$link){
    ...
    if(mysqli_num_rows($res)>= 1){
        ...
        If($link->query("UPDATE Suppliers SET supplier_name ='$supplier_name',  email ='$email', phone = '$phone', address ='address', city = 'city', state ='$state', zipcode ='$zipcode', country ='$country'  
